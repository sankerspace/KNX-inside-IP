...
class EIBConnection:
  ...
  def __EIBGetBusmonitorPacketTS_Complete(self):
    self.__complete = None;
    if self.__EIB_GetRequest() == -1:
      return -1;
    if (((self.data[0])<<8)|(self.data[0+1])) != 21 or len(self.data) < 7:
      self.errno = errno.ECONNRESET
      return -1
    if self.ptr2 != None:
      self.ptr2.data = self.data[2]
    if self.ptr7 != None:
      self.ptr7.data = (((self.data[3])<<24)|((self.data[3+1])<<16)|((self.data[3+2])<<8)|(self.data[3+3]))
    self.buf.buffer = self.data[7:]
    return len(self.buf.buffer)


  def EIBGetBusmonitorPacketTS_async(self, status, timestamp, buf):
    ibuf = [0] * 2;
    self.ptr2 = status
    self.ptr7 = timestamp
    self.buf = buf
  ...
  def EIBGetBusmonitorPacketTS(self, status, timestamp, buf):
    if self.EIBGetBusmonitorPacketTS_async (status, timestamp, buf) == -1:
      return -1
    return self.EIBComplete ()
  ...
  def __EIBOpenBusmonitorTS_Complete(self):
    self.__complete = None;
    if self.__EIB_GetRequest() == -1:
      return -1;
    if (((self.data[0])<<8)|(self.data[0+1])) == 1:
      self.errno = errno.EBUSY
      return -1
    if (((self.data[0])<<8)|(self.data[0+1])) != 22 or len(self.data) < 6:
      self.errno = errno.ECONNRESET
      return -1
    if self.ptr7 != None:
      self.ptr7.data = (((self.data[2])<<24)|((self.data[2+1])<<16)|((self.data[2+2])<<8)|(self.data[2+3]))
    return 0


  def EIBOpenBusmonitorTS_async(self, timebase):
    ibuf = [0] * 2;
    self.ptr7 = timebase
    ibuf[0] = 0
    ibuf[1] = 22
  ...
  def EIBOpenBusmonitorTS(self, timebase):
    if self.EIBOpenBusmonitorTS_async (timebase) == -1:
      return -1
    return self.EIBComplete ()
  ...
  def __EIBOpenVBusmonitorTS_Complete(self):
    self.__complete = None;
    if self.__EIB_GetRequest() == -1:
      return -1;
    if (((self.data[0])<<8)|(self.data[0+1])) == 1:
      self.errno = errno.EBUSY
      return -1
    if (((self.data[0])<<8)|(self.data[0+1])) != 23 or len(self.data) < 6:
      self.errno = errno.ECONNRESET
      return -1
    if self.ptr7 != None:
      self.ptr7.data = (((self.data[2])<<24)|((self.data[2+1])<<16)|((self.data[2+2])<<8)|(self.data[2+3]))
  ...
  def EIBOpenVBusmonitorTS_async(self, timebase):
    ibuf = [0] * 2;
    self.ptr7 = timebase
    ibuf[0] = 0
    ibuf[1] = 23
  ...
  def EIBOpenVBusmonitorTS(self, timebase):
    if self.EIBOpenVBusmonitorTS_async (timebase) == -1:
      return -1
    return self.EIBComplete ()
